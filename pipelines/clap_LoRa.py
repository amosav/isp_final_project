...
class Pipeline:
    def __init__(self,
        ...
        self.model_name = f"model_epoch_{self.num_epochs + 1}_{self.batch_size}_{self.lr}.pt"
...
if __name__ == '__main__':
    ...
    args = sys.argv[1:]
    if len(args) == 3:
        num_epochs, lr, batch_size = args
        pipeline = Pipeline(num_epochs=int(num_epochs),
                            lr=float(lr),
